...
import { Video } from '../../Videos_Temporada3';
...
export const VideoCard = ({ data }: { data: Video }) => {
  ...
  return (
    <div
      className={`flex flex-col transition-transform text-[#91e6fc] hover:text-white group ${today >= availabilityDate && 'hover:scale-[1.08] cursor-pointer'}`}
    >
      ...
      <div
        className={`w-fit mx-auto flex flex-col items-center justify-center px-4 py-2 bg-[#004fa1]/80 rounded-md ${today < availabilityDate && 'bg-[#004fa1]/70'}`}
      >
        <p
